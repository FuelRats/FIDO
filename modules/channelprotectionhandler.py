import fido
from modules.channelprotections import masshighlighting, spamprotection, droneprotection

protections = [masshighlighting.on_message, spamprotection.on_message, droneprotection.on_message]
